        ...
        <div className=' md:h-[100vh] md:w-full  w-full overflow-hidden bg-black md:pt-6 pt-4 pb-6 md:pb-0'>
            ...
            <div className='md:flex gap-32  md:items-center w-full md:mx-14 mx-6 mt-12'>
                ...
                <div className=''>
                    ...
                    <img className='rounded-full border-2 md:w-[400px] md:h-[400px] w-[350px] h-[350px] md:mt-0 mt-8' src="https://i.ibb.co/TbWZ8nS/black-smooth-textured-paper-background-53876-98333.png" alt="" />
                </div>
            </div>
        </div>
    );
